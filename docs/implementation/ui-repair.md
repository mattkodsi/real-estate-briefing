...
Phone-width matrix: 280, 320, 350, 360, 375, 390, 412, 440, 480 and 600 CSS pixels, plus 844×390 landscape. The 280px check initially caught clipped navigation; shorter narrow-screen labels resolved it. Header controls stay in bounds. At 440px the navigation rectangle remained x=12/y=898/w=416/h=48 before and after scrolling.
